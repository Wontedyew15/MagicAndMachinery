package me.kingwonton.multiblock.validators;

import org.bukkit.DyeColor;
import org.bukkit.Material;
import org.bukkit.block.Block;

import me.kingwonton.multiblock.IMaterialValidator;
...
public class DyeColorValidator implements IMaterialValidator {
	...
	public boolean validateBlock(Block block) {
		...
		return DyeColor.getByWoolData(block.getData()) == dyeColor; // ((Wool)block.getState().getData()).getColor() == dyeColor;
	}
}
